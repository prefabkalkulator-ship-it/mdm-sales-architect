...
function App() {
    ...
    var handleSend = function (text) { return __awaiter(_this, void 0, void 0, function () {
        var userMsg, responseText, modelMsg_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, chatService_1.processUserMessage)(text)];
                case 2:
                    responseText = _a.sent();
                    modelMsg_1 = { role: 'model', content: responseText };
                    setMessages(function (prev) { return __spreadArray(__spreadArray([], prev, true), [modelMsg_1], false); });
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
    ...
    return (<>
      <Header_1.default />
      <ChatArea_1.default messages={messages}/>
      <InputArea_1.default onSend={handleSend}/>
    </>);
}
exports.default = App;
